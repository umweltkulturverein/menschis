    ...
    return (
        <div className="grid rounded-lg overflow-hidden shadow-md bg-white dark:bg-ci-blue-700">
            ...
            <div>
                ...
                {guestSubmitted && (
                    <div className="mx-4 mb-4 mt-2 flex items-start gap-2 rounded-md bg-blue-50 dark:bg-ci-blue-600 border border-blue-200 dark:border-ci-blue-500 px-3 py-2">
                        <svg
                            className="w-4 h-4 text-blue-500 dark:text-blue-300 shrink-0 mt-0.5"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        >
                        ...
                        <p className="text-xs text-blue-700 dark:text-blue-200">
                            Check your email — we sent you a link to view and
                    ...
                    <div className="px-4 pb-4 pt-2 space-y-2">
                        ...
                        {isGuest && (
                            <p className="text-xs text-gray-400 dark:text-gray-500">
                                You{"'"}ll receive an email link to edit your
                                registration later.
                            </p>
                        )}
