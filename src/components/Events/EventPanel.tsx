...
export default function EventPanel({ event, onClick }: Props) {
    return (
        <div
            className={`rounded-lg p-4 shadow-md cursor-pointer transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1 ${"bg-white dark:bg-ci-blue-700"}`}
            onClick={onClick}
        >
