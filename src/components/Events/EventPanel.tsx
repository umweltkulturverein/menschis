...
export default function EventPanel({ event, onClick }: Props) {
    return (
        ...
        >
            ...
            <div className="w-full h-32 mb-3 rounded-md overflow-hidden bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900 dark:to-indigo-900 flex items-center justify-center">
                <svg
