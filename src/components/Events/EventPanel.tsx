        ...
        <Link href={`/events/${event.id}`} className="block">
            <div className="rounded-lg p-4 shadow-md bg-white dark:bg-ci-blue-700 hover:shadow-lg transition-shadow duration-200">
                ...
                <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400 mb-2">
                    <div>
                        <span className="text-ci-green-400 dark:text-ci-green-300">Start: </span>
                        <span>
                    ...
                    <div>
                        <span className="text-ci-green-400 dark:text-ci-green-300">End: </span>
                        <span>
                ...
                <div className="flex items-center text-xs text-gray-500 dark:text-gray-400 pt-2 border-t border-gray-100 dark:border-gray-700">
                    <svg className="w-4 h-4 mr-1 text-green-500 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                    <span className="font-medium text-gray-700 dark:text-gray-200">{event.location}</span>
                </div>
            </div>
        </Link>
    );
